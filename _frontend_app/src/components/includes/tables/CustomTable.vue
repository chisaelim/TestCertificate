  ...
  <div class="card">
    <div class="card-header">
      <div class="d-flex justify-content-between">
        <button v-if="onExitBtnClicked" @click="onExitBtnClicked" class="btn btn-outline-secondary">
          Exit
        </button>
        ...
        <div class="d-flex justify-content-end">
          ...
          <button v-if="onCreateBtnClicked" :disabled="disabled" @click="onCreateBtnClicked"
...
/* .table-responsive {
  max-height: calc(100svh - 345px) !important;
}

.modal .table-responsive {
  max-height: calc(100svh - 385px) !important;
} */
</style>
<script setup>
import {
