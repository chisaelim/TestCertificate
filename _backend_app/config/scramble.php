...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Test Certificate REST API documentation.',
    ],
     ...
     */
    /*
     * Servers exposed in the OpenAPI document so Stoplight's "Try It" can target the
     * production API as well as the local dev server.
     */
    'servers' => [
        'Production' => 'https://testcertificate-api.ultralink.cloud/api',
